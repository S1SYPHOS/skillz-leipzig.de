		...
		<div class="grid">
			<div class="grid_two-thirds">
				<label class="form-group">
					...
					<input id="awesomplete" name="title" data-message="Please enter your first name." type="text" placeholder=".. einen oder mehrere Künstler, eine Veranstaltung?" value="<?= isset($data['title']) ? $data['title'] : '' ?>" required>
				</label>
			...
			<div class="grid_one-third">
				<label for="category" class="form-group">
					...
					<select id="category" name="category" value="<?= isset($data['category']) ? $data['category'] : '' ?>" required>
